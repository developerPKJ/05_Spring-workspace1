...
<body>
	...
	<!-- 
		- 다 입력 후 주문 버튼을 누르는 순간 
		  http://localhost:8888/jsp/pizza/order 로 요청을 보낼 것!! 
		  (get 방식)
	-->
	<form action="/jsp/pizza/order" method="get">
		<fieldset>
			...
			<table>
				...
				<tr>
					<th>이름</th>
					<td><input type="text" name="userName" required></td> <!-- required : 필수 입력 사항 -->
				</tr>
				<tr>
					<th>전화번호</th>
		...
		<fieldset>
			...
			<table>
				...
				<tr>
					<th>사이드</th>
					<td>
						<!-- input[type=checkbox name=side value=]*6 -->

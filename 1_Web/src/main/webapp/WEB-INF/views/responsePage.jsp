<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// 스크립틀릿 : html 태그 내에 자바 코드를 작성할 수 있는 구역
	// 4. 2단계에서 request 객체에 담긴 데이터들을, 꺼내서 변수에 기록하기
    ...
    System.out.println((foods == null) ? "null" : String.join(", ", foods));
%>
<!DOCTYPE html>
<html>
<head>
